...
async def analyse_company(company: CompanyData, credentials: str) -> Optional[str]:
    ...
    prompt = (
        ...
        "Дай краткий аналитический вывод по этой компании: "
        "насколько она надёжна как контрагент, каковы основные риски, "
        "что стоит учесть при работе с ней. "
        "Пиши структурированно, каждый пункт с новой строки, без лишних слов."
    )
