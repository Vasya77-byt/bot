...
class GigaChatClient:
    ...
    async def help_user(self, user_text: str) -> Optional[str]:
        ...
        prompt = (
            ...
            "ПРАВИЛА ОТВЕТА:\n"
            "1. Не более 4 коротких строк, без markdown и заголовков.\n"
            "2. Используй ТОЛЬКО названия кнопок и команд из списка выше. "
            "Если в списке такой функции нет — НЕ упоминай её.\n"
            "3. На вопрос «как сделать X» — назови конкретную кнопку или "
            "команду из списка.\n"
            "4. Если запрос не по теме сервиса (погода, шутки, рецепты) — "
            "вежливо скажи что помогаешь только с проверкой компаний, "
            "предложи отправить ИНН или название.\n"
            "5. Не приветствуй ('Здравствуйте...'), сразу по делу."
        )
